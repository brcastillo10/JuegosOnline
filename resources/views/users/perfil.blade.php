...
<body>
  ...
  <!--Barra de color black (Para el modo oscuro pues)-->
  <main class="d-flex flex-nowrap">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
      <a href="/home" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
        ...
        <span class="fs-4">JuegosOnline</span>
      </a>
      <hr>
      ...
      <div class="dropdown">
        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
          <img src="https://i.blogs.es/4e85be/super-saiyan/840_560.jpeg" alt="" width="32" height="32" class="rounded-circle me-2">
          <strong>User</strong>
        </a>
    ...
    <div class="b-example-divider b-example-vr"></div>
      ...
      <!--Barra de color white-->

    <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px;">
      <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
        <img src="/images/icon.png" alt="Home Icon" width="40" height="32" class="me-2"> <!-- Imagen personalizada -->
        <span class="fs-4">JuegosOnline2</span>
      </a>
      <hr>
      <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
          <a href="#" class="nav-link active" aria-current="page">
            <img src="/images/icon.png" width="16" height="16" class="me-2"></img> <!--Remplazar para los iconos (Recomenado usar la pagina de Fontawesome.com)-->
            Inicio
          </a>
        </li>
        <li>
